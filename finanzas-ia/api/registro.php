<?php
// registro.php — crea una cuenta con el plan gratis.
...
if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
  responder(['ok' => false, 'error' => 'Ese correo no parece válido.'], 400);
}
if (strlen($pass) < 6) {
  responder(['ok' => false, 'error' => 'La contraseña debe tener al menos 6 caracteres.'], 400);
}
...
if ($resultado === 'existe') {
  responder(['ok' => false, 'error' => 'Ya existe una cuenta con ese correo. Inicia sesión.'], 409);
}
